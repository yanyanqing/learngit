def call(BUILD_BRANCH) {
            ...
            builds["linux-amd64-centos7"] = {
                node('centos7_build') {
                    ...
                    dir("${ws}/go/src/github.com/pingcap/tidb-binlog") {
                        ...
                        filemgr-linux64 --action mput --bucket pingcap-dev --nobar --key builds/pingcap/tidb-binlog/${githash_centos7}/centos7/tidb-binlog.tar.gz --file tidb-binlog.tar.gz
                        """

                        // update refs
                        writeFile file: 'sha1', text: "${githash_centos7}"
                        sh "filemgr-linux64 --action mput --bucket pingcap-dev --nobar --key refs/pingcap/tidb-binlog/${BUILD_BRANCH}/centos7/sha1 --file sha1"

                        // cleanup
                        sh "rm -rf sha1 tidb-binlog.tar.gz config.cfg"
                    }
                }
            }
            ...
            builds["linux-amd64-centos6"] = {
                node('centos6_build') {
                    ...
                    dir("${ws}/go/src/github.com/pingcap/tidb-binlog") {
                        ...
                        cp ~/bin/config.cfg ./
                        tar czvf tidb-binlog.tar.gz bin/*
                        filemgr-linux64 --action mput --bucket pingcap-dev --nobar --key builds/pingcap/tidb-binlog/${githash_centos6}/centos6/tidb-binlog.tar.gz --file tidb-binlog.tar.gz
                        """

                        // update refs
                        writeFile file: 'sha1', text: "${githash_centos6}"
                        sh "filemgr-linux64 --action mput --bucket pingcap-dev --nobar --key refs/pingcap/tidb-binlog/${BUILD_BRANCH}/centos6/sha1 --file sha1"
    ...
    stage('Summary') {
        ...
        "Binary Download URL:" + "\n" +
        "${UCLOUD_OSS_URL}/builds/pingcap/tidb-binlog/${githash_centos7}/centos7/tidb-binlog.tar.gz" + "\n" +
        "Binary (for Centos6) Download URL:" + "\n" +
        "${UCLOUD_OSS_URL}/builds/pingcap/tidb-binlog/${githash_centos6}/centos6/tidb-binlog.tar.gz"
