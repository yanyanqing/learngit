            ...
            builds["linux-amd64-centos7"] = {
                node('centos7_build') {
                    ...
                    dir("${ws}/go/src/github.com/pingcap/tikv") {
                        ...
                        GOPATH=${ws}/go:$GOPATH ROCKSDB_SYS_STATIC=1 make unportable_release
                        """
            ...
            builds["linux-amd64-centos6"] = {
                node('centos6_build') {
                    ...
                    dir("${ws}/go/src/github.com/pingcap/tikv") {
                        ...
                        sh """
                        rustup override set $RUST_TOOLCHAIN_BUILD
                        scl enable devtoolset-4 python27 "GOPATH=${ws}/go:$GOPATH ROCKSDB_SYS_STATIC=1 make unportable_release"
                        """
