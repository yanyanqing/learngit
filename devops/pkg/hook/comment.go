...
func CompareComments(config *Config, ghIssue *github.Issue, jIssue *jira.Issue, ghClient *GHClient, jClient *JIRAClient) error {
	...
	jIssue, _, err = jClient.client.Issue.Get(jIssue.ID, nil)
	if err != nil {
		return errors.Trace(err)
	}
